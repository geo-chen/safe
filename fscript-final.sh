...
cat /etc/passwd | cut -d ":" -f1 | sort -u > /tmp/fartifact/uselist.log
echo "done..!!! \n"
...
zip -r "/tmp/fartifactupload/archive.zip" /tmp/fartifact/

echo '\n \n sending files to server \n'

###sshpass -p '123' scp -r /tmp/fartifactupload/archive-ubuntu-2019-12-05.zip master@172.16.44.158:/home/master/forensic/evidence.zip

sshpass -p '123' scp -r /tmp/fartifactupload/archive.zip master@172.16.44.158:/home/master/Dropbox/evidence.zip
